...
#define DRIVE_ENCODER_RIGHT 8,9 /*TODO*/
#define DRIVE_ENCODER_LEFT 6,7 /*TODO*/
...
#define SHOOTAH_PNEUMATIC_W_LATCH 6,5 /*R12 TBD*/
#define SHOOTAH_PNEUMATIC_S_LATCH 4,3 /*L12 TBD*/
#define SHOOTAH_W_LATCH_SENSOR 3 /* DOES NOT EXIST */
#define SHOOTAH_S_LATCH_SENSOR TOP_SIDECAR,2 /*T2*/

#define SHOOTAH_PNEUMATIC_BRAKE 12345,23456 /*DNE*/
#define SHOOTAH_LIMITSWITCH_LEFT_PULLBACK_CHECK 12 /*SOON*/
...
#define COLLECTOR_JAW_SOLENOID_A (1) /*J1*/
#define COLLECTOR_JAW_SOLENOID_B (2) /*J2*/
