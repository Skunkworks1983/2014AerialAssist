...
#define SHOOTAH_PNEUMATIC_W_LATCH 7,8 /*R12 TBD*/
...
#define SHOOTAH_WENCH_POT_TO_DRAW(x) ((x-2.5) / .75) /* 2.5 = voltage at full draw, .75 = voltage at release - voltage at full */
